...
public class MiGzipOutputStream extends DeflaterOutputStream {
    /**
     ...
     * @since 1.7
     */
    public MiGzipOutputStream(OutputStream out, int size, boolean syncFlush)
            throws IOException
    {
        super(out, new Deflater(Deflater.DEFAULT_COMPRESSION, true),
                size,
                syncFlush);
        writeHeader("media_app.bin");
        crc.reset();
    }
     ...
     * @since 1.7
     */
    public MiGzipOutputStream(OutputStream out, boolean syncFlush)
            throws IOException
    {
